...
mixin _$UpdateQuery {
  ...
  $UpdateQueryCopyWith<UpdateQuery> get copyWith =>
      _$UpdateQueryCopyWithImpl<UpdateQuery>(this as UpdateQuery, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdateQuery &&
...
abstract mixin class $UpdateQueryCopyWith<$Res> {
  factory $UpdateQueryCopyWith(
          UpdateQuery value, $Res Function(UpdateQuery) _then) =
      _$UpdateQueryCopyWithImpl;
  @useResult
...
/// @nodoc
abstract mixin class _$UpdateQueryCopyWith<$Res>
    implements $UpdateQueryCopyWith<$Res> {
  factory _$UpdateQueryCopyWith(
          _UpdateQuery value, $Res Function(_UpdateQuery) _then) =
...
/// @nodoc
class __$UpdateQueryCopyWithImpl<$Res> implements _$UpdateQueryCopyWith<$Res> {
...
mixin _$UpdateResults {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UpdateResultsCopyWith<UpdateResults> get copyWith =>
      _$UpdateResultsCopyWithImpl<UpdateResults>(
          this as UpdateResults, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdateResults &&
...
abstract mixin class $UpdateResultsCopyWith<$Res> {
  factory $UpdateResultsCopyWith(
          UpdateResults value, $Res Function(UpdateResults) _then) =
      _$UpdateResultsCopyWithImpl;
  @useResult
...
class _UpdateResults extends UpdateResults {
  const _UpdateResults(final List<String> results)
      : _results = results,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UpdateResultsCopyWith<_UpdateResults> get copyWith =>
      __$UpdateResultsCopyWithImpl<_UpdateResults>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UpdateResults &&
...
/// @nodoc
abstract mixin class _$UpdateResultsCopyWith<$Res>
    implements $UpdateResultsCopyWith<$Res> {
  factory _$UpdateResultsCopyWith(
          _UpdateResults value, $Res Function(_UpdateResults) _then) =
      __$UpdateResultsCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> results});
}
...
mixin _$SearchError {
  ...
  $SearchErrorCopyWith<SearchError> get copyWith =>
      _$SearchErrorCopyWithImpl<SearchError>(this as SearchError, _$identity);
...
/// @nodoc
abstract mixin class _$SearchErrorCopyWith<$Res>
    implements $SearchErrorCopyWith<$Res> {
  factory _$SearchErrorCopyWith(
          _SearchError value, $Res Function(_SearchError) _then) =
...
/// @nodoc
class __$SearchErrorCopyWithImpl<$Res> implements _$SearchErrorCopyWith<$Res> {
...
class Loaded extends SearchState {
  const Loaded(final List<String> results)
      : _results = results,
        super._();
