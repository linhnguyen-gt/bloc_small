...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int count)?  initial,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that.count);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int count)  initial,}) {final _that = this;
switch (_that) {
case _Initial():
return initial(_that.count);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int count)?  initial,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that.count);case _:
  return null;
